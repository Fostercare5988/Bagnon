...
if not Bagnon_EngineReady then
	if DEFAULT_CHAT_FRAME then
		DEFAULT_CHAT_FRAME:AddMessage("|cffff2020[Bagnon Fatal Error]|r Bagnon requires the Enhanced 1.12.1 engine (ClassicAPI v1.15.14+ with modern container sorting).", 1, 0.2, 0.2)
	end
	return
end
